...
export default function CustomToastSuccess() {
  ...
  return (
    <div className="w-full h-screen bg-gray-700 flex items-center justify-center p-4">
      {isVisible && (
            ...
            <div className="flex justify-center mb-6">
              <div className="relative w-32 h-32">
                ...
                >
                  ...
                  {/* Checkmark */}
                  <polyline points="50,75 65,90 95,50" className="animate-scale" />
                </svg>
              </div>
            </div>
